...
N3_DATA_FILE = '8ang1_30ms.mat'
#TENSORBOARD_DIR = '/home/Student/s4290365/thesis/tf_models/tensorBoard'
N3_TENSORBOARD_DIR = 'tensorBoard'
#SAVE_DIR = '/home/Student/s4290365/thesis/tf_models/saveDir'
N3_SAVE_DIR = N3_TENSORBOARD_DIR                                                
N3_MODEL_ID = 'net3_arbang.ckpt'                                                
N3_IMG_DIR = N3_TENSORBOARD_DIR + ''                                            
N3_LOAD_MODEL = True                                                            
N3_SAVE_MODEL = False                                                           
N3_WRITE_IMAGES = True  
...
N3_BATCH_SIZE = 100
N3_TOTAL_STEPS = 500001
#HIDDEN_UNITS = 16
N3_LEARNING_RATE = 0.1

# CONVOLUTION params
# TODO dynamically congifure this? inc. in mat file?
N3_KX = 11
N3_KY = 11
N3_KZ = 1  # Use depth 1 (gray scale (decayed) images)
N3_TOTAL_VOXELS = N3_KX * N3_KY * N3_KZ
N3_NUM_FEATURES = 9
N3_CONV_SIZE = 6
...
def runNet(datafile=N3_DATA_FILE, tensorboard_dir=N3_TENSORBOARD_DIR, 
    ...
    load_model=N3_LOAD_MODEL, save_model=N3_SAVE_MODEL, 
    write_image=N3_WRITE_IMAGES, batch_size=N3_BATCH_SIZE,
    total_steps=N3_TOTAL_STEPS, learning_rate=N3_LEARNING_RATE, other_params={}):        
