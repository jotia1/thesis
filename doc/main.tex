...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{UQlogo.png}
\end{figure}
...
I present the
following thesis entitled ``Evaluating frame-based networks with temporal surfaces''.  This work was performed under the supervision of Prof. Janet Wiles.
...
% Family
%I would not be here without the unending support and encouragement from my parents
For reading drafts and endless encouragement I would like to acknowledge and thank my parents. 
