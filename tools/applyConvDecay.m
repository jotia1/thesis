function [ dataset, labels ] = applyConvDecay( starti, endi, xs, ys, ts, ksize, msps, stride, decaytype, k );
%% APPLYDECAY - Given a start and end event, return a matrix of decayed
%           images around each pixel. 
%
%           NOTE: this is is CENTERED around the
%           distiguished event and not the full image.
