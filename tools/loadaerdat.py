""" File taken from https://svn.code.sf.net/p/jaer/code/scripts/python/loadaerdat.py
Believed to have been written (or at least edited) by Federico Corradi (http://sourceforge.net/p/jaer/tickets/129/)

Ported to python3 by Joshua Arnold on 15/09/2015.
"""
...
print(len(loadaerdat(datafile="samp1.aedat", length=0, version='aedat', debug=1, camera='DVS128')))
